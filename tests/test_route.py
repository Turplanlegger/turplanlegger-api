...
class RoutesTestCase(unittest.TestCase):
    ...
    def test_get_route(self):
        ...
        response = self.client.get(f'/route/{created_route_id}', headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_route_not_found(self):
        response = self.client.post('/route', data=json.dumps(self.route), headers=self.headers_json)
        self.assertEqual(response.status_code, 201)
        response = self.client.get('/route/2', headers=self.headers)
    ...
    def test_delete_route(self):
        ...
        response = self.client.delete(f'/route/{created_route_id}', headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_route_not_found(self):
        ...
        response = self.client.delete('/route/2', headers=self.headers)
        self.assertEqual(response.status_code, 404)
